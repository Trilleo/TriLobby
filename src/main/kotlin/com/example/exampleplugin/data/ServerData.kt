...
/**
 * Server-wide data container backed by a JSON file stored on disk.
 *
 * A single instance is managed by [ServerDataManager], which loads it when the
 * plugin enables and saves it when the plugin disables.
 *
...
open class ServerData {
    ...
    /** The raw JSON object holding all persisted server values. */
